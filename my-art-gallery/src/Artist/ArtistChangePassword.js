...
import '../Customer/ChangePassword.css';
import Message from './message';

const ArtistChangePassword = ({ username, onPasswordChangeSuccess }) => {
    ...
    const handleChangePassword = async (e) => {
        ...
        const response = await fetch('http://localhost:9000/artists/ArtistChangePassword', {
            method: 'POST',
            headers: {
