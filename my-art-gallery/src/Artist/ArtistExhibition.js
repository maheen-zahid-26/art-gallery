...
function ArtistExhibition({username}) {
  const handleParticipation1 = async () => {
    try {
      const response = await fetch('http://localhost:9000/admin/ex1', {
        method: 'POST',
  ...
  const handleParticipation2 = async () => {
    try {
      const response = await fetch('http://localhost:9000/admin/ex2', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          username,
  ...
  const handleParticipation3 = async () => {
    try {
      const response = await fetch('http://localhost:9000/admin/ex3', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          username,
  ...
  const handleParticipation4 = async () => {
    try {
      const response = await fetch('http://localhost:9000/admin/ex4', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          username,
